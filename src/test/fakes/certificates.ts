...
export function fakeCertificate(
  ...
  return {
    ...
    certificateDocumentKind: "CERTIFICATE",
    certificateRequiresExpiry: true,
    certificateParentTypeId: null,
    certificateParentTypeCode: null,
    certificateParentTypeName: null,
    certificateVariantFlag: null,
    certificateConvention: "MARPOL Annex I",
    certificateSourceReference: "Test fixture",
    parentCertificateId: null,
    parentCertificateCode: null,
    parentCertificateName: null,
    parentCertificateNumber: null,
    parentCertificateStatus: null,
    parentCertificateWorkflowStatus: null,
    parentCertificateIsDeleted: null,
    childCertificateCount: 0,
    ...
    attachmentCount: 0,
    attachments: [],
    pendingReplacementIngestionId: null,
...
export function fakeCertificateRequirement(
  ...
  return {
    ...
    structuredCertificateRejectionReason: null,
    structuredCertificateBlockingReason: null,
