...
import { useUpdateCertificate } from "@/src/features/certificates/core/hooks/useUpdateCertificate";
...
jest.mock("@/src/features/certificates/core/hooks/useUpdateCertificate", () => ({
