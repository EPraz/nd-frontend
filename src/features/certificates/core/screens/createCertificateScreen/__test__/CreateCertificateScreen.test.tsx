...
import { useCreateCertificate } from "@/src/features/certificates/core/hooks/useCreateCertificate";
import {
  fakeCertificate,
  fakeCertificateType,
  fakeVesselAsset,
...
jest.mock("@/src/features/certificates/core/hooks/useCreateCertificate", () => ({
